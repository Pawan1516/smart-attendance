  ...
  const options = [
    {
      ...
      desc: 'use the camera to scan student QR codes for one specific batch in a session.',
      icon: QrCode,
    ...
    },
    {
      ...
      desc: 'Scan QR codes for multiple batches in a single , streamlined session.',
      icon: Layers,
      accent: 'text-primary',
      bg: 'bg-primary/5',
      mode: 'scan'
    },
    {
      ...
      desc: 'Select a batch and session to manually update the attendance roster.',
      icon: UserCheck,
  ...
  return (
    <div className="max-w-6xl mx-auto min-h-[80vh] flex flex-col items-center justify-center space-y-12 animate-in fade-in duration-700">
      ...
      <div className="text-center space-y-3">
        ...
        <h1 className="text-4xl font-black text-white tracking-tighter uppercase">Attendance </h1>
        <p className="text-[11px] font-bold text-slate-600 uppercase tracking-[0.4em]">Attendance Options</p>
      </div>
